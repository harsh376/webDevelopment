...
$sqlval="Select * FROM tbl_registration where id='".$_REQUEST["id"]."' ";
...
<body topmargin="0">
	...
	<form name="frm" action="updateinfo.php" method="post" onsubmit="return formValid();" enctype="multipart/form-data">
    	...
    	<div style="width:500px; height:500px; background-color:#EBEBEB;">
            ...
            <div style="width:350px; height:40px; float:left; background-color:none;">
            	<input type="text" name="name" value="<?php echo $rowe["name"];?>" id="name" style="float:left;" />
            </div>
            ...
            <div style="width:350px; height:40px; float:left; background-color:none;">
            	<input type="text" name="fatherName" id="fatherName" value="<?php echo $rowe["fatherName"];?>" style="float:left;" />
            </div>
