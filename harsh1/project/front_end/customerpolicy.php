...
<div style="width:1024px; border:0px solid #000000; height:1200px; background-color:#FFFFFF;">						<!--	page div		-->
	...
	<div style="width:700px; height:1000px; background-color:none; float:left;">			<!-- content div	-->
        ...
        <div style="width:660px; margin-left:40px; background-color:none; height:1000px; float:left;">		<!-- this div is for the left margin	-->
          ...
          <p style="text-align:left; font-family:Arial, Helvetica, sans-serif; font-size:13px;">Our endeavor is to provide our customers offbeat, unique and stylish home furnishing products at reasonable price – giving them true value for their money.</p>
          <p>&nbsp;</p>
          <p style="text-align:left; font-family:Arial, Helvetica, sans-serif; font-size:13px;">We will promise our customers what can be delivered and deliver them what has been promised.</p>
          <p>&nbsp;</p>
          <p style="text-align:left; font-family:Arial, Helvetica, sans-serif; font-size:13px;">We will be open to their suggestions and criticisms and based on their feedbacks, continuously strive to improve.</p>
          <p>&nbsp;</p>
          <p style="text-align:left; font-family:Arial, Helvetica, sans-serif; font-size:13px;">Their complaint, if any, is to be faced with utmost seriousness & care. It cannot be considered closed till the solution satisfies them.</p>
