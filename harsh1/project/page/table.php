...
<div style="width:1024px; border:0px solid #000000; height:2300px; background-color:#FFFFFF;">						<!--	page div		-->
	...
	<div class="main_menu" style="width:1024px; border:0px solid #006666; height:50px;">					<!-- 		main menu div		-->
    	...
    	<ul>
			...
			<li><a href="#" style="background-color:#694321;">Table Linen</a>
            	<ul>
	...
	<div style="width:700px; height:2000px; background-color:none; float:left;">			<!-- content div	-->
        ...
        <div style="width:660px; margin-left:40px; background-color:none; height:2000px; float:left;">		<!-- this div is for the left margin	-->
        	...
        	<font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; font-weight:600; color:#666666;"> Table Linen</font>
            
     		<br/>
            
            <div style="line-height:50px; background-color:none; height:50px; float:left;">
                <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:16px; font-weight:600px; float:left; font-weight:600; vertical-align:middle;"> Table Linen</font>
            ...
            <div>
            	<img src="images_table/9-category.jpg" />
            </div>        	
            <br/>
          ...
          <div style="width:660px; height:200px; border-bottom:1px #666666 dashed; padding:20px 0px 20px 0px; background-color:none;"> <!-- item 1 div	-->
              ...
              <div>
                	<img src="images_table/2927-home.jpg" style="float:left;" />
                    ...
                    <div style="width:270px; height:200px; background-color:none; float:left; margin-left:20px;">
                        ...
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; font-weight:600; color:#666666;">Round Table / D.No. 619</font>
                        <br/>
            ...
            <div style="width:660px; height:200px; border-bottom:1px #666666 dashed; padding:20px 0px 20px 0px; background-color:none;"> <!-- item 2 div	-->
              ...
              <div>
                	<img src="images_table/2986-home.jpg" style="float:left;" />
                    ...
                    <div style="width:270px; height:200px; background-color:none; float:left; margin-left:20px;">
                        ...
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; font-weight:600; color:#666666;">Rectangle Table / D.No. 3701</font>
                        <br/>
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; color:#666666;">For more details click on this image</font>
            ...
            <div style="width:660px; height:200px; border-bottom:1px #666666 dashed; padding:20px 0px 20px 0px; background-color:none;"> <!-- item 3 div	-->
              ...
              <div>
                	<img src="images_table/3003-home.jpg" style="float:left;" />
                    ...
                    <div style="width:270px; height:200px; background-color:none; float:left; margin-left:20px;">
                        ...
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; font-weight:600; color:#666666;">Rectangle Table / D.No. 4703</font>
                        <br/>
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; color:#666666;">For more details click on this image</font>
            ...
            <div style="width:660px; height:200px; border-bottom:1px #666666 dashed; padding:20px 0px 20px 0px; background-color:none;"> <!-- item 4 div	-->
              ...
              <div>
                	<img src="images_table/3252-home.jpg" style="float:left;" />
                    ...
                    <div style="width:270px; height:200px; background-color:none; float:left; margin-left:20px;">
                        ...
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; font-weight:600; color:#666666;">Round Table / D.No. 6205</font>
                        <br/>
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; color:#666666;">For more details click on this image</font>
            ...
            <div style="width:660px; height:200px; border-bottom:1px #666666 dashed; padding:20px 0px 20px 0px; background-color:none;"> <!-- item 5 div	-->
              ...
              <div>
                	<img src="images_table/2972-home.jpg" style="float:left;" />
                    ...
                    <div style="width:270px; height:200px; background-color:none; float:left; margin-left:20px;">
                        ...
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; font-weight:600; color:#666666;">Rectangle Table / D.No. 3537</font>
                        <br/>
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; color:#666666;">For more details click on this image</font>
            ...
            <div style="width:660px; height:200px; border-bottom:1px #666666 dashed; padding:20px 0px 20px 0px; background-color:none;"> <!-- item 6 div	-->
              ...
              <div>
                	<img src="images_table/3317-home.jpg" style="float:left;" />
                    ...
                    <div style="width:270px; height:200px; background-color:none; float:left; margin-left:20px;">
                        ...
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; font-weight:600; color:#666666;">Round Table / D.No. 7406</font>
                        <br/>
                        <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; color:#666666;">For more details click on this image</font>
