...
<body topmargin="0" style="background-color:#E6E6E6; height:5000px;">

<center>

<div style="width:1024px; border:0px solid #000000; height:1300px; background-color:#FFFFFF;">						<!--	page div		-->
	...
	<div class="main_menu" style="width:1024px; border:0px solid #006666; height:50px;">					<!-- 		main menu div		-->
    	...
    	<ul>
            ...
            <li><a href="#" style="background-color:#694321;">Accessories</a></li>
		</ul>
    
    </div>											<!-- 		end of main menu div		-->

	<div style="width:700px; height:1000px; background-color:#000000; float:left;">			<!-- content div	-->
    	
        <div style="width:660px; margin-left:40px; background-color:#999999; height:1000px; float:left;">		<!-- this div is for the left margin	-->
        	...
        	<font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; font-weight:600; color:#666666;"> Accessories</font>
            
     		<br/>
            
            <div style="line-height:50px; background-color:none; height:50px; float:left;">
                <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:16px; font-weight:600px; float:left; font-weight:600; vertical-align:middle;"> Accessories</font>
    
                <font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; float:left; color:#666666; vertical-align:middle;">&nbsp;&nbsp;&nbsp;&nbsp;There are no products</font>
            </div>
			
            <div>
            	<img src="images_accessories/11-category.jpg" />
            </div>        	
            <br/>
            
            <div style="width:660px; height:50px; float:left; background-color:#FFCC66; line-height:50px;">
            	<font style="font-family:Verdana, Arial, Helvetica, sans-serif; font-size:12px; font-weight:600px; vertical-align:middle;">There are no products in this category.</font>
            </div>
    ...
    <div id="vertmenu" style="float:left; background-color:#00CC00; border:0px solid #CCFF33; padding-left:40px; padding-right:40px; width:244px; height:1000px;">	<!--vertical side menu div	-->
